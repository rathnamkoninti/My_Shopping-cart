...
from app.forms import LoginForm, MyPasswordChange, MyPasswordResetForm,MySetPasswordForm
urlpatterns = [
    # path('', views.home),
   ...
   # Authentiction
    ...
    (template_name='app/passwordchange.html', form_class=MyPasswordChange,
